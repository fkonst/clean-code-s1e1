...
var incompleteTaskHolder = document.querySelector(".incomplete__list");//ul of .incomplete__list
var completedTasksHolder = document.querySelector(".complete__list");//ul of .complete__list
...
var createNewTaskElement=function(taskString){
    ...
    label.className = "flex-item list__label";

    //Each elements, needs appending
    checkBox.type = "checkbox";
    checkBox.className = "list__checkbox";
    editInput.type = "text";
    editInput.className = "flex-item list__input";
